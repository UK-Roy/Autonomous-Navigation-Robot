...
Encoder encoder_bright(30, 31); //pin is changed from original (31, 30)
...
const uint8_t RB_BACK = 29; //pin was interchanged RB_BACK = 28// RB_FORW = 29
const uint8_t RB_FORW = 28;
bool wtf;
...
float ticks_per_meter = 15486.7256;
